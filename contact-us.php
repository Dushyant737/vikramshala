    ...
    <div id="contact" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Get in touch</h3>
                <p class="lead">Please fill out below form to get more details about our services <br>We have so many happy customers to work with us!</p>
            </div><!-- end title -->
					...
					<div class="address-item">
						...
						<h3>Vikramshaala
							<br> Software
                                                        	<br> Foundation</h3>
						<p> #305, Blue Building
							<br> 1st stage,HBR Layout
                                                        	<br> Bangalore 560043</p>
					</div>
					<div class="address-item">
						<div class="address-icon">
						...
						<h3>Email Us</h3>
						<p>hr@vikramashaala.com
						<br>admin@viramashaala.com</p>
					</div>
					<div class="address-item">
						<div class="address-icon">
