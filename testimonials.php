    ...
    <div id="test-box" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Testimonials</h3>
                <p class="lead">We thanks for all our awesome testimonials! There are hundreds of our happy customers! <br>Let's see what others say about Vikramshaala Software Foundation </p>
            </div><!-- end title -->
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="uploads/testi_01_test.png" alt="" class="img-responsive alignleft">
                                <h4>Thanks & Regards <small>- Program Manager</small></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                ...
                                <h4>Mritunjay Kumar <small>- Designer</small></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                ...
                                <h4>Dushyant Kumar <small>- Bangalore</small></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
