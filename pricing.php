    ...
    <div id="about" class="section wb">
        <div class="container">
			<div class="section-title text-center">
                <h3>Pricing</h3>
                <p class="lead">We thanks for all our awesome testimonials! There are hundreds of our happy customers! <br>Let's see what others say about Vikramshaala Solutions website template!</p>
            </div><!-- end title -->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable">
                        ...
                        <a href="pricing.php" class="pricingTable-signup">Select the plan </a>
                    </div>
                </div>
