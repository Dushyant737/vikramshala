...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Vikramshaala Software Foundation</title>  
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="left-top">
						...
						<div class="email-box">
							<a href="admin@vikramashaala.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> admin@vikramashaala.com </a>
						</div>
					</div>
				</div>
				<!-- <div class="col-md-6 col-sm-6">
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="images/logos/logo.png" alt="image" width="150"></a>
                </div>
...
<li><a href="career.php" class=<?php echo $activePage == 'career' ? 'active' : '' ?> >Career</a></li>
                        ...
                        <li><a href="testimonials.php" class="<?php echo $activePage == 'testimonials' ? 'active' : ''  ?>">Testimonials</a></li>
                       <!-- <li><a href="pricing" class="<?php echo $activePage == 'pricing' ? 'active' : '' ?>">Pricing</a></li> -->
						<li><a href="contact-us.php" class="<?php echo $activePage == 'contact-us' ? 'active' : '' ?>">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
