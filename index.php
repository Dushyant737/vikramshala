					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								<h1 class="homepage-three-title">Software <span>Development</span> Services</h1>
								<h2>Vikramshaala Software Foundation providing, <br>all web design & development solutions. </h2>
								<div class="slider-content-btn">
									<a class="button btn btn-light btn-radius btn-brd" href="about-us.php">Read More</a>
									<a class="button btn btn-light btn-radius btn-brd" href="contact-us.php">Contact</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								...
								<h2>Vikramshaala Software Foundation providing, <br>all web design & development solutions. </h2>
								<div class="slider-content-btn">
									<a class="button btn btn-light btn-radius btn-brd" href="index.php">Read More</a>
									<a class="button btn btn-light btn-radius btn-brd" href="contact-us.php">Contact</a>
								</div>
							</div>
						</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>About Us</h4>
                        <h2>Welcome to Vikramshaala Software Foundation</h2>
                        <p class="lead">Vikramshaala Software Foundation core idea is to improve quality of self learning IT education and provide better learning experience. This is facilitated through multi-modal engagements informal learning groups, short discussions,workshops etc.p>

                        <p> </p>

                        <a href="about-us.php" class="btn btn-light btn-radius btn-brd grd1">Learn More</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>Who We are</h4>
                        <h2>We are Vikramshaala Software Foundation</h2>
                        <p class="lead">Our Foundation’s work in the IT field directly leverages and builds upon the rich experience gained through grass roots level engagements. All the work in the IT field has close linkages with the TOP MNC to ensure a strong two-way connection between theory, research and actual practice.p>
    ...
    <div id="services" class="parallax section lb">
        <div class="container">
            ...
            <!--<div class="text-center">
                <a data-scroll href="Service.php" class="btn btn-light btn-radius btn-brd">View Our Service</a>
            </div>
        </div><!-- end container -->
    </div><!-- end section -->
            ...
            <div class="row text-center">
                <div class="col-md-6">
                    <div class="customwidget text-left">
                        ...
                        <a href="portfolio.php" data-scroll class="btn btn-light btn-radius btn-brd">Learn More</a>
                    </div>
                </div><!-- end col -->
				<!--<div class="col-md-6">
